...
describe('getOriginalTWClassNames', () => {
  ...
  it('rounded', () => {
    ...
    expect(getOriginalTWClassNames(
  ...
  it('border', () => {
    expect(getOriginalTWClassNames(
      'border-t-[2px] border-[4px] border-[0px] border-[1px] border-dashed'))
      .toBe('border-t-2 border-4 border-0 border border-dashed')
    expect(getOriginalTWClassNames(
      'border-t-[2px] border-r-[1px] border-b-[8px] border-l-[0px] border-[8px] border-dashed'))
